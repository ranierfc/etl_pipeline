from src.drivers.testes.http_requester import HttpRequesterSpy
from src.drivers.testes.html_collector import HtmlCollectorSpy
...
def test_extract_error():
    ...
    try:
        ...
        assert isinstance(excpetion, ExtractError)
